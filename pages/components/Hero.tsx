      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-8">
            ...
            <a
              href="#learn-more"
              className="text-blue-400 font-bold hover:text-blue-200 hover:underline transition-colors duration-300"
            >
              Learn More
            </a>
          </div>
        ...
        <div id="learn-more" className="mt-12 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div className="bg-gray-900 rounded-lg p-6 shadow-md transform transition-transform hover:scale-105 duration-300">
              <h3 className="text-xl font-semibold mb-2 text-white">Increased Liquidity</h3>
